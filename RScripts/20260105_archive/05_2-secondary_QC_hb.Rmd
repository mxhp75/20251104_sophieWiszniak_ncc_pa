...
- This object has been filtered for doublets, >10% MT genes and the RBC clusters have been removed

```{r}
re_embed_no_rbc <- readRDS(file = file.path(out_dir, "04-filtering", "re_embed_no_rbc.rds"))
```

- This object has been filtered for doublets and >10% MT genes, RBC clusters removed and cells with hb >0.22% removed

```{r}
re_embed_no_rbc_no_hb <- readRDS(file = file.path(out_dir, "05-secondary_QC", "re_embed_no_rbc_no_hb.rds"))

# Ensure Sophie's annotation is the default identity
