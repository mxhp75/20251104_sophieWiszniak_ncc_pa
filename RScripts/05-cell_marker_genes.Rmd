...
platelet_genes <- c("Nrgn", "Pf4", "Ppbp", "Myl9", "Gng11")
...
DotPlot(re_embed_no_low.qual,
  ...
  NoLegend() +
  scale_y_discrete(limits = c("0", "1", "2", "3", "9", "11", "12", "4", "8", "14", "25", "5", "13", "18", "20", "23", "6", "17", "7", "10", "16", "19", "15", "21", "22", "24"))  # any custom order
