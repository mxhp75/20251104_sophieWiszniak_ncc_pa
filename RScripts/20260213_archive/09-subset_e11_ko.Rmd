...
```{r}
e11_ko <- readRDS(file.path(out_dir, "e11_ko.rds"))

stopifnot(inherits(e11_ko, "Seurat"))

Idents(e11_ko) <- "seurat_clusters"
Idents(e11_ko) <- factor(Idents(e11_ko))
DefaultAssay(e11_ko) <- "RNA"

# Save the existing Seurat clusters
e11_ko$full_dataset_clusters <- e11_ko$seurat_clusters
...
save_if(cellCycle_e11_ko, 
       filename = file.path(out_dir, "09-umap.re_embed_cellCycle_e11_ko.png"),
       width = 8,
       height = 8)
